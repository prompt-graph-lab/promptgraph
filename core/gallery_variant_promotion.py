...
def prepare_gallery_variant_promotion_line(
    ...
    promotion_metadata: Callable[[], dict],
) -> PromptLine:
    """Prepare an unpublished copy; the caller owns validation and publication.

    The ID factory runs after deepcopy. Metadata is requested separately and
    only for each missing provenance dictionary, preserving preparation order.
    """
